...
struct b_functor
{
    ...
    void operator()( Tuple t ) const
    {
        ...
        thrust::get< 6 >( t ) = h_x + m_J*s_x_l + m_J*s_x_r; // b_x
        thrust::get< 7 >( t ) = h_y + m_J*s_y_l + m_J*s_y_r; // b_y
        thrust::get< 8 >( t ) = h_z + m_J*s_z_l + m_J*s_z_r; // b_z
...
struct energy_functor
{
    ...
    energy_functor( const value_type J )
        : m_J( J )
    {}
    ...
    void operator()( Tuple t ) const
    {
        ...
        const value_type h = static_cast< value_type >( 0.5 ) * m_J;
